# SUPERSEDED — Use generate_W2D7_lean_v3.py (which records input SHA-256 provenance).
import json
import sys

infile = sys.argv[1] if len(sys.argv) > 1 else "triples.json"
outfile = sys.argv[2] if len(sys.argv) > 2 else "W2D7_v2.lean"
...
lean.append("-- (2.795 < exact-rational W2,d=7 < 2.805), pre-registered R5 verification band.")
