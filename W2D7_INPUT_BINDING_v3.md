...
## Extractor identity
    ...
    Script:              <FILL: path to extractor script>
    Git commit:          <FILL: commit hash of extractor>
    Execution timestamp: <FILL: ISO-8601 UTC>
    Command line:        <FILL: exact command line invoked>
    Popcount equivalence check run: <FILL — yes/no, and result>
...
whole-archive MD5 cannot see because it never re-touches the archive.
    ...
    ... (30 experiments x 3 files = 90 rows total — all 15 rounds x 2 bases
         for the d7_at_q6_7 patch, as committed in data_manifest.json)
